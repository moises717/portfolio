        ...
        <div className="home" id='home'>
            <div className="home__content">
                ...
                <div className="home__about-me">
                    ...
                    <p>
                        Soy Moisés Barillas, tengo {age} años, actualmente me encuentro cursando la carrera de ingeniería en sistemas. soy una persona al que le gustan los retos y aprender cosas nuevas cada dia, lo cual me ah llevado a conocer entornos de desarrollo como <strong>frontend</strong> y <strong>backend</strong>.
                    </p>
                    <ContentTitle title='Mi historia' />
                    <p>
