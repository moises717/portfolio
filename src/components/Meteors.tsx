			...
			{meteors.map((_, idx) => (
				<span
					...
					className={cn(
						...
						"before:content-[''] before:absolute before:top-1/2 before:transform before:-translate-y-[50%] before:w-[50px] before:h-[1px] before:bg-gradient-to-r dark:before:from-[#64748b] before:from-blue-500 before:to-transparent",
						className,
					)}
					style={{
						top: 0,
